 ...
 *
 */
public class HeadGridView extends android.widget.GridView implements OnScrollListener, android.widget.AdapterView.OnItemClickListener
{
    ...
    public class mListAdapter extends BaseAdapter
    {
		...
		public int getCount() 
		{
			return originalAdapter.getCount() > 0 ? originalAdapter.getCount() + HeadGridView.this.getNumColumnsCompat() : 0;
		}

		@Override
		public Object getItem(int position) 
		{
			return originalAdapter.getItem(position + HeadGridView.this.getNumColumnsCompat());
		}

		@Override
		public long getItemId(int position) 
		{
			return originalAdapter.getItemId(position + HeadGridView.this.getNumColumnsCompat());
		}
		...
		{
			if ( position < HeadGridView.this.getNumColumnsCompat() )
			{
		...
		public View getView(int position, View convert, ViewGroup parent) 
		{
			if ( position < HeadGridView.this.getNumColumnsCompat() )
			{
				...
				int realPosition = position - HeadGridView.this.getNumColumnsCompat();
	...
	public void onItemClick(AdapterView<?> adapter, View view, int position, long id) 
	{
		...
		{
			clickListenerFromActivity.onItemClick(adapter, view, position - HeadGridView.this.getNumColumnsCompat(), id);
		}
	}
}
